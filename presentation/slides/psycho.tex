...
\begin{column}{0.6\linewidth}
 \includeimage[height=1\textheight,width=\linewidth]{most-common-password-list}
\end{column}
...
\begin{frame}
\includeimage[scale=0.6]{code-bad}
...
\includeimage[scale=0.6]{code-good}
\begin{itemize}
\item 1password \\ \url{https://agilebits.com} 
