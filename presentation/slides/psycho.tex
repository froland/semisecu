...
\begin{frame}
\includeimage[height=0.75\textheight,width=\linewidth]{bad-password-storage}
\note{
\textbf{Bad password storage}
\par
... vs tracking all your different passwords.
\par
Online services for storing passwords:
\begin{itemize}
\item \href{https://agilebits.com/onepassword}{1password}
\item \href{https://lastpass.com/index.php?fromwebsite=1}{lastpass}
