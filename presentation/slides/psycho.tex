...
\end{Large}
\pause
\includeimage[width=\linewidth,height=0.7\textheight]{arpanet}
\note{
The web:
\begin{itemize}
...
\includeimage[width=0.8\linewidth]{visa2}
\end{column}
\begin{column}{0.3\linewidth}
...
\begin{frame}
\begin{Large}
\begin{tabularx}{\linewidth}{X<{\raggedleft}cX<{\raggedright}}
...
% was "authorization checks" on the left side
\pause
\\[1em]
