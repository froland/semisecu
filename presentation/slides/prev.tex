...
\begin{frame}
%TODO : too small, contrast, add title, find another image ?
\includeimage[width=0.7\linewidth,height=0.7\textheight]{architecture-problem}
\note{
\begin{itemize}
...
\item Input validation: always on server side, use a positive
  approach
\item Use ad-hoc protection for known attacks. Ad-hoc protection means a protection specialized for a particular attack in
this context.
\end{itemize}
}
\end{frame}
...
%------------------------------------------------
\begin{frame}
%TODO : add keywords for the concepts, don't be too authoritarian in explanation
\frametitle{Development: secure development cycle}
\includeimage[width=0.7\linewidth,height=0.7\textheight]{microsoft-sdl-shield}
\note{
...
%------------------------------------------------
\begin{frame}
%TODO : do not talk about virtual patching here
...
%------------------------------------------------
\begin{frame}
%TODO : add names under the logos + link 
...
%------------------------------------------------
\begin{frame}
%TODO : define application server
...
%------------------------------------------------
\begin{frame}
%TODO : talk here about virtual patching
...
%------------------------------------------------
%TODO : XHR is not disabled by default ! correct the explanation + insert name under logos
\begin{frame}
\frametitle{Browser restrictions}
\includeimage[width=0.9\linewidth,height=0.9\textheight]{browserSecurity}
\note{
\begin{itemize}
...
%------------------------------------------------
\subsection{E-mail}
%TODO : explain that there are solution to avoid spams, explain them after without too much details
%------------------------------------------------
\begin{frame}
\frametitle{E-mail}
