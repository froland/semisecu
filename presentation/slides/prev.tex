...
% TODO le texte est trop petit et illisible
% -> à remplacer par des bullet-points ou a jetter
{\small Code review, Pentesting, Training,\ldots}
\note{
...
Spring
\newline \scriptsize{\url{http://www.springsource.org/}}
\end{figure}
\end{column}
...
% TODO definition inconsistante avec le style de la presentation
% (besoin de mettre ca sur le slide?)
Application server = the program that runs the web application
\vspace{1em}
\begin{itemize}
...
%------------------------------------------------
\begin{frame}
% TODO: Image "Javascript" => "JavaScript"
\frametitle{Browser restrictions}
\includeimage[width=0.9\linewidth,height=0.9\textheight]{browser-security-subtitled}
\note{
\begin{itemize}
