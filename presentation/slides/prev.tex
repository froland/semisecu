...
\item There it no miracle receipt... just guidelines
...
\includeimage[width=0.7\linewidth,height=0.7\textheight]{patches}
\note{
...
\begin{center}
Spring
\includeimage[width=0.8\linewidth]{spring-security}
\end{center}
\end{column}
\begin{column}{0.5\linewidth}
\begin{center}
ESAPI
\includeimage[width=0.8\linewidth]{esapi}
\end{center}
\end{column}
\end{columns}
\note{
...
\begin{center}
\textbf{Browsers offer different options to increase security.}
\end{center}
...
\item XHR allows retrieving pages using JavaScript.
\end{itemize}
}
\end{frame}
...
\begin{center}
\textbf{Impossible to test all the setups.}
\end{center}
\includeimage[width=0.8\linewidth,height=0.8\textheight]{testAll} 
\note{
\begin{itemize}
