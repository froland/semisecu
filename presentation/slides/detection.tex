...
\begin{figure}
\includeimage[width=0.8\linewidth]{metasploit-logo}
Metasploit
...
\begin{figure}
\includeimage[width=0.8\linewidth]{nessus-logo}
Nessus
...
\begin{figure}
\includeimage[width=0.8\linewidth]{nmap-logo}
NMAP
...
\begin{column}{0.5\linewidth}
\begin{figure}
\includeimage[width=0.8\linewidth]{webscarab-logo}
WebScarab
...
\includeimage[width=\linewidth,height=0.5\textheight]{bt5-screenshot}
\begin{center}
BackTrack
...
\includeimage[width=0.8\linewidth,height=0.7\textheight]{analysis-tools2}
\note{
\begin{itemize}
