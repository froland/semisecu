...
\begin{frame}
%TODO : add names and references, define why the tool is useful, split in several slides, backtrack is a linux distrib integrating all the tools
\frametitle{Tools}
\begin{columns}
\begin{column}{0.35\linewidth}
\includeimage[width=\linewidth]{pentesting-tools}
\end{column}
\begin{column}{0.65\linewidth}
\includeimage[width=\linewidth,height=0.7\textheight]{bt5-screenshot}
\end{column}
\end{columns}
\note{
\begin{itemize}
...
\begin{frame}
%TODO : add name and motivation of tools + precise if it's free or not
