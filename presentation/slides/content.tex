...
\item Can simply be unintentional or accidental.
	Examples include: loss of electricity, a software failure, a hardware
...
\item Input validation: always on server side, use a positive approach.
	% TODO describe a positive approach
...
However, a secure development cycle should foresee some time for:
\begin{itemize}
...
% TODO add an example (see slides)
