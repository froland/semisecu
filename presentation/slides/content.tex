...
% TODO Separate each attack in description and then another paragraph for
...
input patterns.
% TODO explain why not black-list
...
% TODO include an example <script>alert(...
...
% TODO explain session hijacking vs session fixation
