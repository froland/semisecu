...
The purpose of this document is to introduce the basics concepts of
security in web application. In the software engeneering world, web
applications share some specific: they use many elemnts, some of them
...
designs his complete solution; but also the analyst who has to choose
the right trade-off between usability and security or even the project
manager who has to think about it while keeping the balance between
...
theses capabilities require money, competency but above all it
...
message.
The signature is made using your private key.
It is the encrypted hash of a message.
The hash is a fixed size string built using an irreversible function from a
message. Hashes are used to guarantee the \emph{integrity} of the document.
