...
Who you are.
%\includeimage[scale=0.1]{identity}
\end{block}
\pause
\begin{block}{Authentication}
Are you who you claim to be?
%\includeimage[scale=0.1]{authentication}
\end{block}
\pause
\begin{block}{Authorization}
What are you allowed to do?
%\includeimage[scale=0.1]{authorization}
\end{block}
\note{
\begin{block}{Identity}
...
\begin{frame}
%TODO : mention presence of pre-established password policies
...
%TODO : Add a slide to explain what a CA is
%------------------------------------------------
\begin{frame}
