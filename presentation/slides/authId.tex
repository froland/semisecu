...
able to communicate with someone, you have to use a preestablished
key.

Public key criptography was designed has been design to solve that
...
private key pair and givethe public one to the other.  
\begin{block}{PKI}
