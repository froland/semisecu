...
\includeimage[height=0.8\textheight]{browserPasswordValidation}
\note{
...
\begin{center}
\includeimage[width=0.7\linewidth,height=0.7\textheight]{one-time-password}
\end{center}
\note{
...
\begin{center}
\includeimage[width=0.7\linewidth,height=0.7\textheight]{de}
Chosen using a random or at least pseudo-random way
\end{center}
\note{
...
\includeimage[width=1\linewidth,height=1\textheight]{certificatesVariety}
\note{
...
\begin{center}
IS
\includeimage[width=0.8\linewidth]{multifactor-is}
\end{center}
\end{column}
\begin{column}{0.3\linewidth}
\begin{center}
OWNS
\includeimage[width=0.8\linewidth]{multifactor-own}
\end{center}
\end{column}
\begin{column}{0.3\linewidth}
\begin{center}
KNOWS
\includeimage[width=0.8\linewidth]{multifactor-know}
\end{center}
\end{column}
\end{columns}
\note{
...
\includeimage[scale=0.7]{signature}
\note{
...
\includeimage[scale=0.6]{kerberos}
\end{frame}
...
\begin{center}
\textbf{User may lose its authentication !}
\end{center}
\note{
