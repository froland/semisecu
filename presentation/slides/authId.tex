...
% TODO changer la couleur de la clé (le rouge ne passe pas bien)
...
% TODO les couleurs sont inversées pour les clefs
...
\end{center}
% TODO list the authentication means before presenting them
\note{
% TODO missing note
}
\end{frame}
...
\begin{columns}
\begin{column}{0.5\linewidth}
% TODO replace or remove the following image
...
% TODO parler des self-signature au niveau CA
\note{
	Bullet points.
}
\end{frame}
...
% TODO one-way, two-way
% indiquer "Browser" et "Server" dans les images
% les images sont trop petites (=> width=\linewidth?)
\begin{frame}
\frametitle{One-way}
...
\bfseries
IS
% TODO replace the image by a fingerprint
...
\end{center}
% TODO the images must be the same size
% (personal note: the height is more important than width)
\end{column}
\end{columns}
\note{
\begin{center}
...
% TODO SSO: add Active Directory

%------------------------------------------------
\subsection{Compromised authentication mean}

% TODO transition frame needed
