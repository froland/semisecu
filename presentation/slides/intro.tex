...
\includeimage[width=\linewidth]{hermes-team}
\end{column}
\end{columns}
...
\begin{centering}
cryptography
\includeimage[width=\linewidth]{https}
\end{centering}
\end{column}
\end{columns}
\note{
...
\begin{columns}
\begin{column}{0.5\linewidth}
\includeimage[width=\linewidth]{developer}
\end{column}
\begin{column}{0.5\linewidth}
...
\begin{columns}
\begin{column}{0.5\linewidth}
  \includeimage[width=\linewidth]{architect}
\end{column}
\begin{column}{0.5\linewidth}
\includeimage[width=\linewidth]{blueprint}
\end{column}
\end{columns}
\note{
...
\begin{columns}
\begin{column}{0.5\linewidth}
\includeimage[width=\linewidth]{business_analyst}
\end{column}
\begin{column}{0.5\linewidth}
\begin{center}
...
\end{column}
\begin{column}{0.3\linewidth}
\includeimage[width=0.9\linewidth]{investigation}
investigate
\end{column}
\begin{column}{0.3\linewidth}
