...
\begin{frame}
\includeimage[width=1\linewidth]{client-server}
\note{
\begin{itemize}
...
%TODO : redo the schema using only 1 key (same color)
%note : mention exemple encryption algorithm ? 
\begin{frame}
...
\begin{frame}
%TODO : insist on the different keys
...
\begin{frame}
%TODO : add a schema and add the last argument
\begin{center}
\begin{tabular}{c|c}
...
%TODO : move to before sym and asym compareason, image too small
\begin{frame}
\frametitle{Public-private keys}
\includeimage[width=\linewidth,height=0.6\textheight]{ppk}
\note{
...
\begin{frame}
%TODO : too small and explain the motivation of hash functions + erase base64 from picture
