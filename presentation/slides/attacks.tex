...
% TODO different twice...=> that may influence risk  ?
\end{block}
\end{frame}
...
\item The attacker tries
	...
	% TODO The only one with a verb should be uniform
	\end{itemize}
...
% TODO up to date or up-to-date not both
\end{block}
