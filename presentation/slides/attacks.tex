...
\end{columns}
\note{
% TODO Maxime Mathy avait un exemple pour le crime organisé, demandez-lui.
\begin{description}
\item[External threats]
	\hfill
	\begin{itemize}
...
\begin{frame}
%TODO : virer la mamie et mettre une prise débranchée du mur
% (ou des cables arrachés)
\frametitle{Threat agents}
\begin{columns}
\begin{column}{0.4\linewidth}
...
\begin{frame}
%TODO : virer logo cybercafé, url trop petite, XSS => mauvaise abbréviation(utilisée nulle part avant)
% (regarde le titre de l'attaque precedente...)
% je ne fais que transcrire mes notes des corrections ;-)
...
\end{exampleblock}
\begin{exampleblock}{Session guessing}
...
% TODO fusionner avec le slide precedent
\begin{frame}
\begin{center}
...
% TODO fusionner avec le slide precedent (cf. attaque 4)
\begin{frame}
\begin{center}
...
they are sent.
% In french: "esionner le contenu et même l'altérer"
