...
\includeimage[width=\linewidth,height=2.5cm]{hacker}
\includeimage[width=0.6\linewidth,height=2cm]{yes-i-can}
\end{column}
\begin{column}{0.3\linewidth}
\includeimage[width=\linewidth,height=2.5cm]{crew}
...
\includeimage[width=\linewidth,height=3cm]{public-computers}
\end{column}
\begin{column}{0.3\linewidth}
\begin{center}
\emph{XSS}
...
\includeimage[width=\linewidth,height=4cm]{client-server}
\end{column}
...
\begin{lstlisting}
<img alt=""
	src="http://example.com/comment/post?message=hello" />
\end{lstlisting}
\end{center}
\note{
...
\begin{columns}
\begin{column}{0.8\linewidth}
\includeimage[height=0.6\textheight,width=\linewidth]{rainbow-table-example}
\end{column}
\begin{column}{0.2\linewidth}
...
\end{columns}
\pause
\includeimage[width=0.6\linewidth,height=0.4\textheight]{backup}
\note{
...
\includeimage[height=0.3\textheight,width=\linewidth]{encryption-schema}
\end{block}
\begin{block}{Hash + Salt}
\includeimage[height=0.4\textheight,width=\linewidth]{hash-salt}
\end{block}
\note{
...
\begin{block}{Forward}
\includeimage[height=0.2\textheight,width=\linewidth]{webapp-forward}
\end{block}
\begin{block}{Redirect}
\includeimage[height=0.3\textheight,width=\linewidth]{webapp-redirect}
\end{block}
\note{
...
\url{http://bank.com/secured/../redirect?url=http://evil-bank.com/secured}
\end{exampleblock}
\note{
...
\includeimage[width=0.8\linewidth]{dos}
\note{
...
\end{exampleblock}
\pause
\includeimage[width=0.8\linewidth,height=0.4\textheight]{hannibal-lecter}
\begin{quote}
Quid pro quo, Clarice...
\end{quote}
%\includeimage[width=0.8\linewidth,height=0.6\textheight]{quidproquo-subtitle}
\note{
\begin{description}
\item[Pretexting]
